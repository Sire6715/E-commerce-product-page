...
export default function Cart() {
  ...
  const { cartItems,setCartItems, handleDeleteClick } = useStateContext()
  ...
  return (
    <div className={cartOrder ? "border-b-black shadow-lg flex items-start top-[5em] rounded-lg  p-4 right-0 flex-col w-[22em]  md:w-[23em] absolute bg-white"
      : "border-b-black shadow-lg top-[5em] rounded-lg  p-4 right-0 w-[22em]  md:w-[23em] absolute bg-white flex flex-col justify-center items-center"}>
